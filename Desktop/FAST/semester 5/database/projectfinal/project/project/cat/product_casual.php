      ...
      <nav class="navbar navbar-expand-lg navbar-light"> <a class="navbar-brand" href="#"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="nav navbar-nav ml-auto under">
            <li class="nav-item active"> <a class="nav-link home_box" href="#">Home <span class="sr-only">(current)</span></a> </li>
      ...
      <div class="row"> 
        ...
        ?>
            <div class="col-sm-10 center_col col-xl-5 col-md-10 col-lg-10">
              <div class="photo"> <img src="admin/upload/<?php echo $row[2];?>" alt="pro_shoes" class="card-img"/> <input type="file" name="img" style="visibility: hidden;"></div>
              ...
              <div class="row" style="padding:5px 0px; 0px 0px">
                <div class="col-1"></div>
                <div class="col-5 ">
                  <h6 class="price hvr-float-shadow">Rs.<?php echo $row[5]?><input type="text" name="nprice" style="visibility: hidden;"></h6>
                </div>
                <div class="col-5">
            ...
            <div class="col-12 right_cent">
              ...
              <form action="#" method="POST">
                <div class="row row_shopop">
                  <div class="col-12">
                    <h6 class="catFilter">Category Wise</h6>
                ...
                <input type="submit" name="prodFilters" id="prodFilters" value="Filter" class="btn btn-primary" >
